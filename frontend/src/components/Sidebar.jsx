            ...
            >
                                ...
                                navItems.map(({text, icon}) => {
                                    ...
                                    return (
                                        <ListItem key={text} disablePadding>
                                            ...
                                            sx={{
                                              background: active === lcText ? theme.palette.secondary[300] : "transparent",
                ...
                <Box position='absolute' bottom='2rem'>
                    ...
                    <FlexBetween textTransform='none' gap='1rem' m="1.5rem 2rem 0 3rem">
                            <Box component='img' alt='profile' src='./assets/profile-pic.jpg' height='40px' width='40px' borderRadius='50%' sx={{objectFit: 'cover'}}/>
                                <Box textAlign='left'>
